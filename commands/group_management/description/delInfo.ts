...
const delInfoDescription = new comDesc("/del_info [group_name]", "безвозвратно стирает описание группы", 2, "group_name - группа, информацию о которой вы хотите удалить", "ВАЖНО: это действие нельзя будет отменить. Отдавайте отчёт о том, что делаете.")

export const DeleteInfo = new command(delInfo, "del_info", delInfoDescription)